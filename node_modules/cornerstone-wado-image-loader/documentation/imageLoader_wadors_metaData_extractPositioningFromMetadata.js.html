...
<head>
    ...
    <meta charset="utf-8">
    <title>imageLoader/wadors/metaData/extractPositioningFromMetadata.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">imageLoader/wadors/metaData/extractPositioningFromMetadata.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import getNumberValues from './getNumberValues.js';
import {
