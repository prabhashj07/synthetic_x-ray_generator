...
<head>
    ...
    <meta charset="utf-8">
    <title>imageLoader/wadors/metaData/NMHelpers.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">imageLoader/wadors/metaData/NMHelpers.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import getTagValue from '../getTagValue.js';
